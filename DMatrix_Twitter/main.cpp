...
int main(int argc, char* argv[]) {
    ...
    //            }
	    ...
	    //std::cout << "twitter edge number: " << groundedgetmp.size() << std::endl;
	    //std::cout << "twitter node number: " << groundnodetmp.size() << std::endl;
            if (numfile != 0) {
                groundedge.clear();
                groundnode.clear();
	    ...
	    //std::cout << "tp: " << tp << " cnt: " << cnt << std::endl;
	    //std::cout << "heavyhitteredge.size(): " << heavyhitteredge.size() << " reerhitteredge: " << reerhitteredge << std::endl;
    ...
    //        }
		...
		//std::cout << "tp: " << tp << " cnt: " << cnt << std::endl;
	        //std::cout << "heavychangeredge.size(): " << heavychangeredge.size() << " groundedge.size(): " << groundedge.size() << " reerchangeredge: " << reerchangeredge << std::endl;
